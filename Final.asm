ORG 0000H
Start: MOV P3, #0FFH; IR connected to Port3. No block, IR’s output is logic1. (Only for software simulation purpose)
...
SJMP BACK1
MotorForward: SETB P2.0; This loop closes the gate.
CLR P2.1
ACALL DELAY1
ACALL DELAY1
ACALL DELAY
